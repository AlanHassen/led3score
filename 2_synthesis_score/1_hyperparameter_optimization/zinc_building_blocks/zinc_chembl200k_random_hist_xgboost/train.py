...
def k_fold(dataset, y_column, learning_rate = 0.3, max_depth = 6, n_estimators = 100, min_split_loss = 0, number_of_folds=5):
...
def main():
    ...
    results = k_fold(dataset= training_csv, y_column = "Y_zinc", learning_rate = learning_rate, max_depth = max_depth, n_estimators = n_estimators, min_split_loss = min_split_loss)
    wandb.log({
