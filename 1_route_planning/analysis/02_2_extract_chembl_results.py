...
led3_azf_result_csv_path = "./led3_score/1_route_planning/led3/chembl_200k/led_chembl200k_results.csv"
led3_azf_results_df = extract_results(led3_azf_result_csv_path)

zinc_azf_result_csv_path = "./led3_score/1_route_planning/zinc/chembl_200k/zinc_chembl_200k_results.csv"
zinc_azf_results_df = extract_results(zinc_azf_result_csv_path)

original_chembl200k_path = "./led3_score/data/chemical_datasets/casp/chembl29_200k_random_sampled_molecules.csv"
...
original_chembl200k_df["zinc_result"] = zinc_azf_results_df["number_of_solved_routes"]

result_path = "./led3_score/data/results/1_route_planning/chembl200k_results.csv"
original_chembl200k_df.to_csv(result_path, index=False)

led3_result_path = "./led3_score/data/results/1_route_planning/single_results/led3_chembl200k_results.csv"
led3_azf_results_df.to_csv(led3_result_path, index=False)

zinc_result_path = "./led3_score/data/results/1_route_planning/single_results/zinc_chembl200k_results.csv"
...
assert (original_chembl200k_df["zinc_result"] == zinc_azf_results_df["number_of_solved_routes"]).all()
...
zinc_diff = original_chembl200k_df["clean_smiles"] != zinc_azf_results_df["target"]
